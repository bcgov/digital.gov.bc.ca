      ...
      <PageContainer id="main-content-anchor">
        <Grid>
          ...
          <p>
            <strong>
              <i>
                Note: This guidance is intended primarily to provide broader
                public sector entities with information on video communications
                platforms during the COVID-19 pandemic. This information should
                not be considered exhaustive. Information for government
                ministries can be found under the heading “Video Communications
                Platforms – Information for Government Ministries” below. This
                is a rapidly changing space, and you are encouraged to research
                the latest updates to ensure protection of information.
              </i>
            </strong>
          </p>
          <Title2>
          ...
          <p>
            ...
            Fortunately, there are many options available for video
            communication platforms or tools, many of which can also be used for
            instant messaging or chat, screen sharing and transferring files.
            These options vary by:
          </p>
          <ul>
            <li>Cost</li>
            <li>
              Compatibility (some may require a download, while others work in a
              web browser)
            </li>
            <li>
          ...
          <p>
            Video communication platforms are crucial to working remotely, but
            it is important to ensure that use of these tools addresses privacy,
            security and legal risks. Here we provide some general
            considerations and information to assist broader public sector
            entities in determining which platforms may be suitable for their
            particular needs. Broader public sector entities are encouraged to
            consult their privacy and security experts and to seek legal advice
          ...
          <p>
            ...
            <HrefLink href="http://www.bclaws.ca/civix/document/id/complete/statreg/96165_03#section30.1">
              section 30.1 of the Freedom of Information and Protection of
              Privacy Act
            </HrefLink>{' '}
            ...
            circumstances. One of these circumstances allows public bodies to
            use third-party tools or applications such as video communication
            platforms, which may be hosted outside Canada, to support and
            maintain the operation of programs or activities of the public body
            where such use supports public health recommendations or
            requirements related to minimizing transition of COVID-19 (e.g.,
          ...
          <p>
            ...
            should be. For example, your health information is more sensitive
            than your opinion of the weather, so it would be reasonable to
            expect your health information be protected to a higher degree. If
            you are an employee of a broader public sector entity and your job
            includes sharing potentially personal, sensitive or confidential
            information, you are encouraged to consult your organization for
            specific guidance on which tools to use.
          </p>
          <p>
          ...
          <p>
            <strong>
              Determine whether you will be sharing
              personal/sensitive/confidential or public information.{' '}
            </strong>
          </p>
          <p>Some questions to ask:</p>
          <ul>
            <li>
              How sensitive is the information that I will be sharing or
              processing over my intended platform or tool?
            </li>
            <li>
            ...
            <li>
              Who would want to steal this information and does my intended
              platform or tool protect this information from them?
            </li>
            <li>
              What are the risks to sharing this information, and is my
              organization willing to accept those risks to achieve our business
              objectives? Are there any risks that must be addressed in order to
              ensure compliance with legislative requirements?
            </li>
          </ul>
          <p>
            If your information is personal/sensitive/confidential, ensure the
            tool you are using has sufficient security controls in place to
            protect the information.
          </p>
          <p>
            <strong>
              Choose a service provider with strong security and privacy
          ...
          <ul>
            ...
            <li>
              Be familiar with and comply with the service provider’s customer
              use and responsibility policy.
            </li>
            <li>
              Seek advice from your organization’s privacy and security experts
              and legal advisors before using any tool or agreeing to any terms
              and conditions. That way, you can avoid inadvertently accepting
              terms and conditions that breach your organization’s security
              requirements (e.g., if the service provider claims ownership of
              any recorded conversations, content, metadata, or files shared
              over their platform).
            </li>
            <li>
              Consider the service provider’s encryption standards. They should
              be encrypting data while it is in transit <em>and</em> at rest.
              Strong encryption, such as Transport Layer Security (TLS), is
              necessary.
            </li>
            <li>
              Find out what personal and potentially sensitive information the
              service provider collects about meeting participants. For example,
              do they collect names, roles, organizations, email addresses,
              usernames, passwords, or the devices used? Learn how the service
              provider will use this information and let participants know what
              to disclose during registration.
            </li>
            <li>
              Use different passwords and credentials than the ones you use for
              your work accounts.
            </li>
            <li>
              Compare the privacy and security features offered between
              providers and between subscription plans. You may discover a
              paid-for plan offers better security than a free one.
            </li>
          </ul>
          <p>
          ...
          <ul>
            <li>
              Modify the meeting’s settings when the default settings do not
              meet your organization’s security requirements.
            </li>
            <li>
              Send invitations securely. Use email or encrypted messaging apps
              to send links to your meeting. Do not share links or access
              credentials over public websites or social media.
            </li>
            <li>
          ...
          <ul>
            <li>
              Host your video conference from a private location. If you can’t
              find one, use headphones so that only meeting participants can
            ...
            <li>
              Consider what others can see behind you. Remove or conceal
              anything that should be kept private. Some video communication
              tools (e.g., MS Teams) let you blur the background or use a
              virtual background.
            </li>
            <li>
          ...
          <ul>
            <li>
              Consider who you allow to join your meeting. You can restrict
              access by requiring participants to enter a password to join. You
              can also allow authenticated users only, or registered or
              domain-verified users only (i.e., people whose email addresses
              include approved domains). On some tools, you can make
              participants wait in virtual lobbies before they join the meeting.
            </li>
            <li>
              Watch or listen for cues that someone has joined the meeting. Ask
              participants to identify themselves when they join by phone. Do
              not share information if unidentified participants are in your
              meeting.
            </li>
            <li>Lock the meeting once all participants have joined.</li>
            <li>
              Learn how to eject unwanted participants quickly and prevent them
              from re-joining.
            </li>
            <li>
          ...
          <p>
            <strong>
              Provide a collection notice, if required, and conduct due
              diligence whenever personal information will be collected or
              disclosed.{' '}
            </strong>
          </p>
          <ul>
            <li>
              ...
              requires each individual to be informed of:
              <ul>
                <li>
            ...
            <li>
              ...
              bodies, no collection notice is required; however, there may be
              other legislative requirements that must be met.
            </li>
            <li>
              Public bodies are encouraged to conduct appropriate due diligence,
              including seeking legal advice where appropriate, for use of any
              video communication platform in situations where personal
              information will be collected or disclosed, particularly where the
              platform provider is based in the U.S.
            </li>
          </ul>
          <p>
          ...
          <ul>
            <li>
              ...
              messaging, or chat. Limiting or disabling these channels will
              avert unauthorized content and other distractions.
            </li>
            <li>
            ...
            <li>
              ...
              appropriate. For example, documents where the copyright is owned
              by a third party should not be shared, unless your organization
              has a license that permits this.
            </li>
            <li>
              Notify participants in advance if you will be recording or
              transcribing the meeting and manage recordings in accordance with
              your organization’s policies.
            </li>
            <li>
              Do not use private messaging for confidential information, as
              hosts may have access to chat logs.
            </li>
          </ul>
          <Title3>
          ...
          <p>
            ...
            B.C. public sector may be using the free version of Zoom to
            communicate with colleagues and clients. Please be aware of the
            privacy and security vulnerabilities – primarily, weak encryption
            that generally falls short of B.C. government standards. This
            vulnerability means information is not adequately protected. If you
            are sharing confidential information, do not use Zoom if you have
            access to a secure alternative.
          </p>
          <p>
            Other vulnerabilities include the ability for hackers to steal your
            Windows login credentials, and for uninvited participants to join
            and disrupt your Zoom meetings – called “Zoombombing.”
          </p>
          <p>
            It is up to each broader public sector entity to determine whether
            Zoom is appropriate for use within that organization. Broader public
            sector entities are encouraged to consult with their privacy and
            security experts and legal advisors to assess the risks associated
            with their intended use of Zoom. Where a broader public sector
          ...
          <ul>
            ...
            <li>
              ...
              and regularly check for updates. For more information on
              installing apps, read the{' '}
            ...
            <li>
              ...
              (e.g., firstname_lastname, or Jane_Smith). This helps the meeting
              host verify participants against the invitation list.
            </li>
            <li>
              <strong>Do not use your organization credentials </strong>to log
              into Zoom.
            </li>
            <li>
              ...
              ) and change your password immediately if you think someone may
            ...
            <li>
              ...
              . Instead, allow Zoom to automatically generate a random meeting
              ID for you.
            </li>
            <li>
              <strong>
          ...
          <ul>
            <li>
              <strong>Set screen sharing to “Host Only.</strong>” This allows
              you, as the host, to reject any unwanted content from
              participants.
            </li>
            <li>
              <strong>Disable “Join Before Host.</strong>” Instead, use the
              “Waiting Room” feature to admit participants and keep out
              uninvited guests.
            </li>
            <li>
              <strong>Enable “Co-Host</strong>” if you (as the host) want to
              assign moderating duties to other participants.
            </li>
            <li>
              <strong>
                Be aware of everything your camera can see around you
              </strong>{' '}
          ...
          <ul>
            <li>
              <strong>Verify participants </strong>by comparing names against
              the invitation list.
            </li>
            <li>
              <strong>Lock the meeting</strong> once all attendees have joined
              to prevent uninvited guests.
            </li>
            <li>
              <strong>Disable “Allow Removed Participants to Rejoin.”</strong>
            </li>
            <li>
              <strong>Disable “File Transfer” </strong>and do not click on links
              or open attachments.
            </li>
            <li>
              <strong>Do not use Zoom’s cloud storage</strong>. You can stream
              or edit documents that do not have any personal, sensitive or
            ...
            <li>
              ...
              <em>Freedom of Information and Protection of Privacy Act.</em> If
              you do record a meeting, save the recording locally and never in
              Zoom’s cloud storage.
            </li>
            <li>
              <strong>
                Disclose personal information only if your organization has
                determined that it is appropriate and lawful to do so, and limit
                any disclosure of personal information
              </strong>{' '}
              to the minimum amount reasonably necessary for performing your
              duties as an employee, officer or minister of the public body. In
              other words, consider what personal information is needed to get
              the job done and only share that information via Zoom.
            </li>
            <li>
              <strong>Turn off video and/or audio by default</strong> when
              joining a meeting (in Zoom Settings) to protect your privacy.
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              Zoom is based in the United States and may store data outside
              Canada. Your organization will need to assess whether the use of
              Zoom, including for meetings that may include the collection
              and/or disclosure of personal information, is appropriate and
              lawful.
            </li>
          </ul>
          <p>
          ...
          <p>
            The B.C. Ministry of Education has secured and funded licences for
            the enterprise version of Zoom for all K-12 public and independent
            schools in B.C. This version of Zoom has many features to enable
            secure meetings. Find more information and resources for teachers
            and school administrators on the ministry’s{' '}
          ...
          <Title2>
            <strong>
              Video Communication Platforms – Information for Government
              Ministries
            </strong>
          </Title2>
          <p>
            The video communication platforms that have been approved at a
            corporate level for use within government are:
          </p>
          <ul>
            <li>Skype</li>
          ...
          <p>
            ...
            should seek internal legal advice. Other tools may become available,
            and employees are encouraged to check here regularly for updated
            information.
          </p>
          <Title2>
