...
const instructions = [
  'Clearly define the <b>problems</b> you’re trying to solve, the outcomes you want to improve, or the value you want to deliver for the users of your service',
