export const issueComment = {
  name: 'issue_comment',
  id: 'd14f8c00-dd8d-11ea-8e7f-cd2a557c611f',
  payload: {
    action: 'created',
    issue: {
    ...
    comment: {
      ...
      html_url: 'https://github.com/patricksimonian/strapi-demo/issues/9#issuecomment-673622509',
      issue_url: 'https://api.github.com/repos/patricksimonian/strapi-demo/issues/9',
      id: 673622509,
      node_id: 'MDEyOklzc3VlQ29tbWVudDY3MzYyMjUwOQ==',
      user: {
        login: 'patricksimonian',
        id: 21046727,
        node_id: 'MDQ6VXNlcjIxMDQ2NzI3',
